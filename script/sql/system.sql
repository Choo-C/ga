...
insert into sys_dept values(101,  100, '0,100',      '开发部',   1, '', '', '', '0', '0', 'admin', sysdate(), '', null);
...
-- 初始化-用户信息表数据
-- ----------------------------
insert into sys_user values(1,  101, '', 'admin', '管理员', 'sys_user', '', '', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', sysdate(), 'admin', sysdate(), '', null, '管理员');
...
insert into sys_oss_config values (1, 'minio',  'XXXXXXXXXXXXXXX',  'XXXXXXXXXXXXXXX', 'oss',             '', '127.0.0.1:9000',                '',                   'N', '',             '1' ,'0', '', 'admin', sysdate(), 'admin', sysdate(), NULL);
insert into sys_oss_config values (2, 'qiniu',  'XXXXXXXXXXXXXXX',  'XXXXXXXXXXXXXXX', 'oss',             '', 's3-cn-north-1.qiniucs.com',     '',                   'N', '',             '1' ,'1', '', 'admin', sysdate(), 'admin', sysdate(), NULL);
insert into sys_oss_config values (3, 'aliyun', 'XXXXXXXXXXXXXXX',  'XXXXXXXXXXXXXXX', 'oss',             '', 'oss-cn-beijing.aliyuncs.com',   '',                   'N', '',             '1' ,'1', '', 'admin', sysdate(), 'admin', sysdate(), NULL);
