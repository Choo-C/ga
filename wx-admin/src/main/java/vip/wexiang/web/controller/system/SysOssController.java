...
import vip.wexiang.common.core.validate.QueryGroup;
...
public class SysOssController extends BaseController {
    ...
    @SaCheckPermission("system:oss:remove")
    @Log(title = "OSS对象存储", businessType = BusinessType.DELETE)
    @DeleteMapping("/removeByUrls")
    public R<Void> removeByUrls(@NotEmpty(message = "文件路由不能为空") @RequestParam String[] urls) {
        return toAjax(iSysOssService.deleteByUrls(urls));
    }
